...
// Build headers for sending to admin
$headers = "From: $sender_email\r\n";
$headers .= "Content-type: text/html\r\n";

// Check if mail function is available (good for debugging on XAMPP)
if (function_exists('mail')) {

    // Send to admin
    $sent_to_admin = mail($contact_email, $sender_subject, $new_message, $headers);

    // Send confirmation to sender
    $subject = "Welcome to my website";
    $msg = "I shall get to you soon, thanks for contacting us!";
    $headers2 = "From: abeyjoe18@gmail.com\r\n";
    $headers2 .= "Content-type: text/plain\r\n";

    $sent_to_sender = mail($sender_email, $subject, $msg, $headers2);

    if ($sent_to_admin && $sent_to_sender) {
        echo "<h2 align='center'>Your message has been sent successfully</h2>";
    } else {
        echo "<h2 align='center'>Message failed to send. (Email function error)</h2>";
    }

} else {
    echo "<h2 align='center'>Mail function not available on this server.</h2>";
}
